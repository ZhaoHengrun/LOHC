...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder(self, x, human, mask_ratio):
        # embed patches
        ...
        x, human, mask, ids_restore = self.random_masking(x, human, mask_ratio)  # x:[b, 25, 128], mask:[b, 256], ids_restore:[b, 256]
    ...
    def forward(self, img_with_seg, human_with_seg, mask_ratio):
        latent, human, mask, ids_restore = self.forward_encoder(img_with_seg, human_with_seg, mask_ratio)
