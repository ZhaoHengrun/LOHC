...
from models.base import BaseDiscriminator, deconv_factory, get_conv_block_ctor, get_norm_layer, get_activation
from models.ffc import FFCResnetBlock
...
class HumanImageDiscriminator(BaseDiscriminator):
    def __init__(self, input_nc=3, ndf=64, n_layers=6, norm_layer=nn.BatchNorm2d,):
        super().__init__()
        self.n_layers = n_layers
...
class MultidilatedNLayerDiscriminator(BaseDiscriminator):
    def __init__(self, input_nc=3, ndf=64, n_layers=4, norm_layer=nn.BatchNorm2d, multidilation_kwargs={}):
        super().__init__()
        self.n_layers = n_layers
